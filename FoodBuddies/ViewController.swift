...
extension ViewController {
    ...
    fileprivate func prepareImageCard() {
        ...
        card.contentViewEdgeInsetsPreset = .wideRectangle9
        
        card.bottomBar = bottomBar
        card.bottomBarEdgeInsetsPreset = .wideRectangle9
        
        view.layout(card).vertically(top: 100, bottom: 100)//.center()
       // view.layout(card).width(350).height(500).center()
    }
}
